...
export class HelpView extends LitElement {
    ...
    render() {
        const shortcutRows = [
            ...
            ['Telegram Screenshot Only', this.keybinds.telegramScreenshotOnly],
            ...
            ['Scroll Code Left', this.keybinds.scrollLeft],
            ['Scroll Code Right', this.keybinds.scrollRight],
            ['Reconnect System Audio (macOS)', this.keybinds.reconnectSystemAudio],
